...
export default function Header({
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-gradient-to-r from-slate-950/90 via-slate-900/85 to-slate-950/90 backdrop-blur-xl border-b border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.35)]">
      
      {/* Optional subtle top highlight line */}
      <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-corporate-gold/30 to-transparent"></div>
      ...
      {/* Desktop Navigation */}
      <nav className="hidden lg:block border-t border-white/10 bg-slate-950/70 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-4 lg:px-6">
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="lg:hidden bg-slate-950/95 backdrop-blur-xl border-t border-white/10 shadow-2xl animate-fade-in-down">
