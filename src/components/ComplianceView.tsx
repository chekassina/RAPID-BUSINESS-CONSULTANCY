...
export default function ComplianceView({
  ...
  const [selectedAgencyId, setSelectedAgencyId] =
    useState<string>("pacra");

  const activeAgency =
    COMPLIANCE_AGENCIES.find(
      (a) => a.id === selectedAgencyId
    ) || COMPLIANCE_AGENCIES[0];
  ...
  const handleInquiryAction = (
    ...
    if (setBookingCategory) {
      setBookingCategory(
        `Zambian Compliance setup - ${agency.name}`
      );
    }
  ...
  return (
    <div
      className="animate-fade-in py-16 px-4"
      id="compliance-view-container"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-gray-300 mt-4 text-xs sm:text-sm leading-relaxed">
            Operating a business without correct statutory
            filings triggers severe fines or complete
            blacklisting. We navigate complex portals to
            register your firm securely with leading
            statutory boards and professional licensing
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3 mb-10">
          {COMPLIANCE_AGENCIES.map((agency) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-10 h-10 rounded-full mx-auto flex items-center justify-center font-black text-xs mb-2 transition-colors ${
                    isSelected
                      ? "bg-corporate-blue-dark/20 text-corporate-blue-dark"
                      : "bg-corporate-blue-dark/50 text-corporate-gold"
                  }`}
                >
                ...
                <span className="text-[9px] text-gray-400 font-bold block mt-auto pt-1">
                  Zambia
                </span>
              </button>
            );
        ...
        <div className="bg-corporate-blue-light border border-corporate-gold/20 rounded-sm p-6 sm:p-10 shadow-xs grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <div className="inline-flex items-center gap-1.5 bg-corporate-gold/10 text-corporate-gold font-bold text-[10px] py-1 px-3 rounded-full uppercase tracking-wider mb-2">
                ...
                Approved Guidance Track
              </div>

              <h2 className="text-2xl sm:text-3xl font-black text-white">
                {activeAgency.fullName} (
                {activeAgency.name})
              </h2>
            </div>
            ...
            <div className="border-t border-corporate-gold/15 pt-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pb-2">
                {activeAgency.requirements.map(
                  (req, rid) => (
                    <div
                      key={rid}
                      className="flex items-start gap-2.5 bg-corporate-blue-dark/30 p-3.5 rounded-sm border border-corporate-gold/10 hover:border-corporate-gold/25 transition-colors"
                    >
                      <CheckCircle2 className="w-4 h-4 text-emerald-400 shrink-0 mt-0.5" />

                      <span className="text-xs text-gray-300 font-semibold leading-relaxed">
                        {req}
                      </span>
                    </div>
                  )
            ...
            {/* Extra Licensing Platforms */}
            <div className="border-t border-corporate-gold/15 pt-6">
              <h3 className="font-extrabold text-sm text-corporate-gold uppercase tracking-wider mb-4">
                Additional Licensing Platforms We Assist With
              </h3>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-corporate-blue-dark/30 border border-corporate-gold/10 rounded-sm p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <BadgeCheck className="w-4 h-4 text-corporate-gold" />
                  ...
                  <p className="text-xs text-gray-300 leading-relaxed">
                    ...
                    Authority supplier registration,
                    e-GP setup, and tender compliance.
                  </p>
                </div>

                <div className="bg-corporate-blue-dark/30 border border-corporate-gold/10 rounded-sm p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Scale className="w-4 h-4 text-corporate-gold" />
                ...
                <div className="bg-corporate-blue-dark/30 border border-corporate-gold/10 rounded-sm p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <BriefcaseBusiness className="w-4 h-4 text-corporate-gold" />
                  ...
                  <p className="text-xs text-gray-300 leading-relaxed">
                    Zambia Human Resource Management
                    Institute registration and HR
          ...
          <div className="bg-corporate-blue-dark/60 rounded-sm p-6 border border-corporate-gold/15 flex flex-col justify-between gap-6">
            <div className="space-y-4">
              ...
              <div className="text-xs text-gray-300 space-y-2 leading-relaxed">
                <p>
                  ...
                  or missing annual returns timelines
                  leads to immediate freeze actions and
                  compounding interest.
                </p>

                <p>
                  We coordinate with authority officers
                  to submit compliance folders with
                  minimal wait times.
                </p>
              </div>
            ...
            <div className="space-y-2 pt-4 border-t border-corporate-gold/15 animate-pulse-subtle">
              <button
                onClick={() =>
                  handleInquiryAction(activeAgency)
                }
              ...
              <button
                onClick={() => {
                  const url = `https://wa.me/260963910639?text=${encodeURIComponent(
              ...
              <button
                ...
                className="w-full bg-white/10 hover:bg-white/20 text-white font-extrabold py-3 rounded-sm text-xs transition-all"
              >
                Call Direct: +260775449792
              </button>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
            <div className="max-w-xl">
              ...
              <p className="text-gray-300 mt-2 text-xs sm:text-sm leading-relaxed">
                Rapid Business compiles, notarizes, and
                prepares your entire bidding document
                packet including ZPPA registration,
                company constitutions, profiles, and
            ...
            <div>
              <button
                onClick={() => {
                  if (setBookingCategory) {
                    setBookingCategory(
                      "Tender Bidding Document Compiles"
                    );
                  }
